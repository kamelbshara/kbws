...
const SECTION_KEYS = ["intro", "dataCollected", "dataUse", "dataSharing", "dataSecurity", "userRights"] as const;
  ...
  return (
    <div className="flex min-h-screen flex-col bg-brand-cream">
      ...
      <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-8 px-6 py-16">
        ...
        <p className="rounded-md border border-brand-gold/30 bg-white p-4 text-sm text-slate-600">
          {t("contactNote")}
        </p>
      </main>
      <PublicFooter />
